...
create table if not exists document_test_table
(
    id int auto_increment
        primary key,
...
create table if not exists public_customer_query
(
    id int auto_increment
        primary key,
...
create table if not exists forgot_password_info
(
    id int auto_increment
        primary key,
    email varchar(255) not null,
...
create table if not exists jwt_tail
(
    user_id int not null
        primary key,
    email varchar(255) not null,
...
create table if not exists temp_password_info
(
    id int auto_increment
        primary key,
    email varchar(255) not null,
...
create table if not exists user_avatar_image
(
    user_id int not null
        primary key,
